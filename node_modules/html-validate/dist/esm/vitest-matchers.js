import { g as getReport, d as diverge, c as createSyncFn, a as codeframe } from './vitest-utils.js';
import { o as deepmerge, a6 as vitestWorkerPath } from './core.js';
import * as vitest from 'vitest';
import { a as FileSystemConfigLoader, H as HtmlValidate } from './core-nodejs.js';

async function toBeValid(received) {
...
async function toBeInvalid(received) {
  const report = await getReport(received, this);
  if (report.valid) {
    return {
      pass: false,
