import { a2 as codeFrameColumns, a3 as getEndLocation, a4 as getStartLocation, Q as defineConfig } from './core.js';
import { a as FileSystemConfigLoader, H as HtmlValidate, l as legacyRequire } from './core-nodejs.js';
...
async function getReport(received, state2) {
  const resolved = await received;
  if (typeof resolved === "string") {
    const { testPath = "inline" } = state2;
...
export { codeframe as a, createSyncFn as c, diverge as d, getReport as g };
